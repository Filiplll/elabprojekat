...
class JavniPozivRequest extends FormRequest
{
    ...
    {
        return [
            'broj_slobodnih_mesta' => 'required|integer|min:1|max:50',
    ...
    {
        return [
            'broj_slobodnih_mesta.required' => 'Broj slobodnih mesta je obavezan.',
